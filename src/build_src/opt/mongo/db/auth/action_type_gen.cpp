...
namespace mongo {
    ...
    const ActionType ActionType::checkFreeMonitoringStatus(checkFreeMonitoringStatusValue);
    const ActionType ActionType::cleanupOrphaned(cleanupOrphanedValue);
    const ActionType ActionType::clearJumboFlag(clearJumboFlagValue);
    ...
    const ActionType ActionType::dropConnections(dropConnectionsValue);
    ...
    const ActionType ActionType::getDatabaseVersion(getDatabaseVersionValue);
    const ActionType ActionType::getDefaultRWConcern(getDefaultRWConcernValue);
    ...
    const ActionType ActionType::killAnyCursor(killAnyCursorValue);
    ...
    const ActionType ActionType::listCachedAndActiveUsers(listCachedAndActiveUsersValue);
    ...
    const ActionType ActionType::refineCollectionShardKey(refineCollectionShardKeyValue);
    ...
    const ActionType ActionType::runAsLessPrivilegedUser(runAsLessPrivilegedUserValue);
    ...
    const ActionType ActionType::setDefaultRWConcern(setDefaultRWConcernValue);
    const ActionType ActionType::setFeatureCompatibilityVersion(setFeatureCompatibilityVersionValue);
    const ActionType ActionType::setFreeMonitoring(setFreeMonitoringValue);
    ...
    const ActionType ActionType::trafficRecord(trafficRecordValue);
    ...
    Status ActionType::parseActionFromString(const std::string& action, ActionType* result) {
        ...
        if (action == "checkFreeMonitoringStatus") {
            *result = checkFreeMonitoringStatus;
            return Status::OK();
        }
        ...
        if (action == "clearJumboFlag") {
            *result = clearJumboFlag;
            return Status::OK();
        }
        ...
        if (action == "dropConnections") {
            *result = dropConnections;
            return Status::OK();
        }
        ...
        if (action == "getDatabaseVersion") {
            *result = getDatabaseVersion;
            return Status::OK();
        }
        if (action == "getDefaultRWConcern") {
            *result = getDefaultRWConcern;
            return Status::OK();
        }
        ...
        if (action == "killAnyCursor") {
            *result = killAnyCursor;
            return Status::OK();
        }
        ...
        if (action == "listCachedAndActiveUsers") {
            *result = listCachedAndActiveUsers;
            return Status::OK();
        }
        ...
        if (action == "refineCollectionShardKey") {
            *result = refineCollectionShardKey;
            return Status::OK();
        }
        if (action == "reIndex") {
            *result = reIndex;
        ...
        if (action == "runAsLessPrivilegedUser") {
            *result = runAsLessPrivilegedUser;
            return Status::OK();
        }
        ...
        if (action == "setDefaultRWConcern") {
            *result = setDefaultRWConcern;
            return Status::OK();
        }
        if (action == "setFeatureCompatibilityVersion") {
            *result = setFeatureCompatibilityVersion;
            return Status::OK();
        }
        if (action == "setFreeMonitoring") {
            *result = setFreeMonitoring;
            return Status::OK();
        }
    ...
    std::string ActionType::actionToString(const ActionType& action) {
        ...
        case changeStreamValue:
            return "changeStream";
        case checkFreeMonitoringStatusValue:
            return "checkFreeMonitoringStatus";
        case cleanupOrphanedValue:
            return "cleanupOrphaned";
        case clearJumboFlagValue:
            return "clearJumboFlag";
        ...
        case fsyncValue:
            return "fsync";
        case getDatabaseVersionValue:
            return "getDatabaseVersion";
        case getDefaultRWConcernValue:
            return "getDefaultRWConcern";
        ...
        case killAnyCursorValue:
            return "killAnyCursor";
        ...
        case killopValue:
            return "killop";
        case listCachedAndActiveUsersValue:
            return "listCachedAndActiveUsers";
        ...
        case refineCollectionShardKeyValue:
            return "refineCollectionShardKey";
        case reIndexValue:
            return "reIndex";
        case removeValue:
            return "remove";
        ...
        case runAsLessPrivilegedUserValue:
            return "runAsLessPrivilegedUser";
        case serverStatusValue:
            return "serverStatus";
        case setAuthenticationRestrictionValue:
            return "setAuthenticationRestriction";
        case setDefaultRWConcernValue:
            return "setDefaultRWConcern";
        case setFeatureCompatibilityVersionValue:
            return "setFeatureCompatibilityVersion";
        case setFreeMonitoringValue:
            return "setFreeMonitoring";
